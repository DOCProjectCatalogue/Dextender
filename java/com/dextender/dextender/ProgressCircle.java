...
public class ProgressCircle extends View {
    ...
    private int mInactiveColor = Color.parseColor("#400080"); // was ff4040
    ...
    //
    // This method appears to grab the values from the laoyout and put them here
    // Which basically means, they are hardcoded
    // This really should have more flexability.. but let's see what I Can do with it
    //================================================================================
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mInactiveColor = attributes.getColor(R.styleable.SeekCircle_inactiveColor, Color.parseColor("#400080"));
